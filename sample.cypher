...
//CREATE INDEX ON :`V_PRO4`(`category`);
//CREATE CONSTRAINT ON (node:`V_PRO1`) ASSERT node.`id` IS UNIQUE;
...
//CREATE CONSTRAINT ON (node:`V_PRO3`) ASSERT node.`id` IS UNIQUE;
...
//CREATE CONSTRAINT ON V_PRO1 ASSERT id IS UNIQUE;
//CREATE CONSTRAINT ON Node ASSERT name IS UNIQUE;
//CREATE CONSTRAINT ON V_PRO1 ASSERT test_svr IS UNIQUE;
//CREATE CONSTRAINT ON V_PRO3 ASSERT target IS UNIQUE;
//CREATE CONSTRAINT ON V_PRO3 ASSERT id IS UNIQUE;
//COMMIT;
//BEGIN;
//MATCH (n1:V_PRO1 {'id':763}), (n2:V_PRO1 {'id':552}) CREATE (n1)-[:E_NO_PRO]->(n2);
